...
def load_to_sql(file_path):
    ...
    engine = sqlalchemy.create_engine(f"postgresql+psycopg2://{conn.login}:{conn.password}@mlops-project-3_9475e0-postgres-1:{conn.port}/{conn.schema}")
